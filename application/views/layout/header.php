            ...
            <header id="header" class="static-sticky transparent-header split-menu clearfix">
                <div id="header-wrap" style="background-image: url('<?php echo base_url(); ?>assets/theme2/res/images/sketch-header.png');">
                    <div class="container clearfix">
                        ...
                        <div id="logo">
                            <a href="demo-restaurant.html" class="standard-logo"><img src="<?php echo base_url(); ?>assets/images/logo.png" alt="Canvas Logo"></a>
                            <a href="demo-restaurant.html" class="retina-logo"><img src="<?php echo base_url(); ?>assets/images/logo.png" alt="Canvas Logo"></a>
                        </div>
