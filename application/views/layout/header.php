...
<html class="no-js" lang="en">
    ...
    <body ng-app="App" class="stretched sticky-footer" data-loader-html="<span class='loadingimage'><img src='<?php echo base_url(); ?>assets/theme2/res/images/dosapreloader.gif'>'<h2 class='font-secondary'>Loading...</h2> </span>">
