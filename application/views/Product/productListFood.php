    ...
    <div class="content-wrap nopadding">
        <div class="container">
            ...
            if ($location == "tst") {
                ...
                ?>
                <div class="well well-sm mt-5 mb-5 row">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <h2 class="text-center">
                            <img class="img-thumbnail" src="<?php echo base_url(); ?>assets/locations/commingSoon.jpg" alt="Wan Chai Location" style="border-radius: 20px;" />
                        </h2>
                    </div>
                    <div class="col-md-3"></div>
