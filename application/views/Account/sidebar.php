    ...
    <div class="side-bar shop-sidbar">
        <nav class="woocommerce-MyAccount-navigation">
            <ul>
                ...
                <li class="woocommerce-MyAccount-navigation-link woocommerce-MyAccount-navigation-link--dashboard credit_page"><a href="<?php echo site_url("Account/credits"); ?>" >Credits</a></li>
