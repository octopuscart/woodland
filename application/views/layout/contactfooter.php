<div class="container section-contact topmargin-lg clearfix footercontact" style="background:url(<?php echo base_url(); ?>assets/theme2/res/images/vegbackground.jpg)">
