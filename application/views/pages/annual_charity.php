                                            ...
                                            <li data-percent="81">
                                                <div class="progress">
                                                    <div class="progress-percent">
                                                        <div class="counter counter-inherit counter-instant"><span data-from="0" data-to="42" data-refresh-interval="30" data-speed="1100"></span>%</div>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <form class="mb-0 row"  action="#" method="post" >
                                        ...
                                        <div class="row">
                                            <div class="donation-amount-block">
                                                <div class="amoutblock" ng-repeat="amount in donationinput.amountarray">
                                                    {{amount}}
                                                </div>
                                                <br/>
                                                <div class="otheramountblock mt-3">
                                                    <label>Enter Other Amount</label>
                                                    <input type="text" id="template-contactform-name" name="name" value="" class="form-control border-form-control required" placeholder="HK$ Other" required="">
                                                </div>
                                            </div>
                                            <div class="headerformblock">
                                                ...
                                                <div class="col-sm-12  ">
                                                    <textarea type="text" id="template-contactform-message" name="message" value="" class="required email form-control border-form-control" placeholder="Type you message here" required="" max="300"></textarea>
                                                </div>
                                                <br/>
                                                <div class="col-md-12">
                                                    <div class="headerformblock">
                                        ...
                                        <div class="col-12 nobottommargin" style='    text-align: center;'>
                                            <button class="button button-circle button-large text-white ml-0 mt-3 colordarkgreen" type="submit" name="submit_now" value="submit">Donate Now</button>
                                        </div>
                                        <div class="clear"></div>
